...
export default function f(){
    return(
        <ThemeWrapper>
            ...
            <br></br>
            Click here (NOT_YET_DEFINED) for proof.<br></br>
            <br></br>
            ...
            <br></br>
            The player proposing the game or (if the proposer is an outsider) initiating the game will say "Start(in your language) Nan”, then all players will form a circle, with the initiator being 0 and the player number increasing by 1 each player clockwise from the initiator.<br></br>
