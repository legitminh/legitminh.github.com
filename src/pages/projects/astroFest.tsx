...
export default function f(){
    return(
        <ThemeWrapper>
            <Navbar></Navbar>
            <center>
                <div className=" text-8xl content-center text-c0 w-screen">
                    Astro Fest
                </div>
            </center>
            <div className=" ml-[8rem] mr-[8rem]">
                ...
                {/* Game */}
                <center>
                    <div className=" border-c0 border-2">
                        <iframe width={960} height={640} allow="autoplay; fullscreen *; geolocation; microphone; camera; midi; monetization; xr-spatial-tracking; gamepad; gyroscope; accelerometer; xr; cross-origin-isolated" allowTransparency={true} frameBorder="0" allowFullScreen={true} scrolling="no" src="https://html-classic.itch.zone/html/7383859/Astronomia/index.html" id="game_drop"></iframe>
                    </div>
                </center>
