...
const NavFolder = (props: {
  ...
  if (props.destination == "" || props.destination == undefined) {
    ...
    selfTitle = (
      <div className="flex text-c0">
        {/* Link segtion */}
        <div className="underline text-c0">
          <Link href={props.destination}>{props.title.substring(0, 2)}</Link>
        </div>
        {/* Rest of title */}
  ...
  return (
    ...
    >
      <div
          ...
          () => {
            if (open) {
              ...
              setChildrenRender(
                ...
                <div
                  className="h-screen bg-ccBlue" /*className="h-screen bg-slate-400"*/
                >
        ...
        className={
          "inline-block w-20 text-c0 overflow-scroll scrollbar-hide bg-ccBlue hover:bg-c8Blue"
        }
      >
        {selfTitle}
      ...
      <div className="absolute top-0 inline-block">
        {/* always active childrenS div */}
        {childrenRender}
      </div>
    </div>
  );
