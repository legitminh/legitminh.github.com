...
props: {
    ...
    return (
        ...
        {/* The outside border */}
            ...
            <div ref={containerRef} className=" relative w-[100%] h-[100%] border-cc0 border-[1px] overflow-clip scrollbar-hide cursor-pointer">
            {/* The inside visible area */}
                <div className=" flex h-full w-full">
                    {/* IMAGE */}
                    <div className=" absolute h-full w-full overflow-clip">
                        <Image unoptimized={true} // Disable Next.js optimization for static export
                             className={" object-cover h-full object-center"}
                        src={props.img} alt="" width={2048} height={2048}/>
                        <div className="absolute inset-0 bg-cff opacity-75"></div>
                    </div> 
                    ...
                    <div className={` absolute w-full h-full transition-transform duration-500 ${isVisible? 'top-[1rem] opacity-100' : '-translate-y-full opacity-0'}`} >
                        <div className=" pl-[2rem]"> 
                            <div className=" lg:text-[1.5rem] md:text-[1.5rem] text-[1.5rem] text-c00">
                                {props.description}
                            </div>
                        </div>
                    </div>
                    ...
                    <div className={` absolute w-full h-full transition-transform duration-500 ${isVisible? 'right-[1rem] opacity-100' : '-translate-x-full opacity-0'}`}>
                        ...
                        <div className=" relative h-full">
                            ...
                            <div className=" absolute bottom-0 right-0 text-right text-c00">
                                ...click to learn more
                            </div>
                        </div>
                        {/* DATE */}
